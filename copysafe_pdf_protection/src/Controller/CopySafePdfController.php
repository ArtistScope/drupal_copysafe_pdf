...
/**
 * CopySafePdfController class.
 */
class CopySafePdfController extends ControllerBase {
  ...
  public function openEmbedOptionsModalForm(Request $request, $fid = NULL) {
    ...
    $modal_form = $this->formBuilder->getForm('Drupal\copysafe_pdf_protection\Form\CopySafePdfClass', ['fid' => (int) $fid]);
